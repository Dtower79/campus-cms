...
export interface ApiAfiliadoAfiliado extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AfiliadoOtroSindicato: Schema.Attribute.Boolean &
    ...
    CosGrup: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    FechaRecibido: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    PermisoComunicaciones: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    TelefonoFijo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    TipoContrato: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCursCurs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    glossari: Schema.Attribute.RichText &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    es_professor: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
